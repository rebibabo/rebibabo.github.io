...
tags:
  ...
  - 交易模式
  - RTB
description: programmatic-ads里 RTB、PMP、PD、PDB 这些模式到底是什么关系？用"问题驱动"的演化叙事，讲清楚单 SSP 内部交易模式的完整演化逻辑。
---
...
讲programmatic-ads之前，先看看**它出现之前**是什么样的。
...
## 四、2008 年：OA 公开竞价（programmatic-ads诞生）

### 4.1 OA 是什么

**OA（Open Auction，公开竞价）** 是programmatic-ads的开山鼻祖。
...
**OA 解决了所有人工合约的核心痛点**——这就是为什么 2010 年后programmatic-ads爆发式增长。

### 4.3 OA 的竞价机制：一价 vs 二价

OA 内部又分两种竞价机制——
**这是programmatic-ads里最有意思的部分**。
...
这是博弈论的经典应用——
2008 年之后，**整个programmatic-ads行业都采用二价（GSP）**。
...
**PD（Preferred Deal，首选交易）** 是programmatic-ads里第一个**非竞价**模式：
...
PDB 是programmatic-ads里**最接近传统人工合约**的模式——
...
> programmatic-ads的演化，是一部"如何在自动化效率和人工合约确定性之间找平衡"的历史。
...
> 本文是「programmatic-ads学习笔记」系列第 5 篇。  
> 系列目录：
> - (0) 先看清楚整个江湖
> - (1) DSP：广告主的"代理人"
> - (2) DSP 身边的 4 个帮手
