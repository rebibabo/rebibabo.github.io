...
**DMP（Data Management Platform，数据管理平台）** 是programmatic-ads生态的**数据仓库**。
...
这是**programmatic-ads里最常用的精准定向手段之一**。
...
**整个闭环不需要人工干预**——这是programmatic-ads的精髓。
...
> 本文是「programmatic-ads学习笔记」系列第 2 篇。  
> 系列目录：
> - (0) 先看清楚整个江湖
> - (1) DSP：广告主的"代理人"
> - (2) DSP 身边的 4 个帮手 ← 当前
