...
graph TD
    ...
    chm --> seg1["Segment 1<br>lock"]
    chm --> seg2["Segment 2<br>lock"]
```
...
graph TD
    ...
    transferIndex --> t2["线程2 认领 [4, 5]"]
    transferIndex --> t3["线程3 认领 [2, 3]"]
    transferIndex --> t4["线程4 认领 [0, 1]"]
```
...
graph TD
    ...
    root --> cc0["CounterCell[0]"]
    root --> cc1["CounterCell[1]"]
    root --> cc2["CounterCell[2]"]
    root --> ccN["..."]
```
