...
┌──────────────┐          ┌──────────────┐              ┌──────────────┐
│ put task     │ ───────▶ │ store tasks  │ ───────────▶ │ take task    │
└──────────────┘          └──────────────┘              └──────────────┘
```
...
```text
tail link  ── protected by putLock
head link  ── protected by takeLock
count      ── protected by AtomicInteger
```
...
acquire putLock
        │
        ▼
wait on notFull if queue is full
        │
        ▼
append node at tail
        │
