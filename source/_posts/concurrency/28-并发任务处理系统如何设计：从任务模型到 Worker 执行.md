---
title: 并发任务处理系统如何设计：从任务模型到 Worker 执行
date: 2026-07-05
tags:
  - Java
  - 并发编程
...
```text
submit speed > process speed
        ↓
queue backlog grows
        ↓
task wait time increases
```
...
wait time increases
    ↓
problem is likely in queueing

execute time increases
    ↓
problem is likely in processing
```
