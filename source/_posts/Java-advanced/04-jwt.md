...
![mermaid](/images/Java-advanced/IMG-20260707-000013.png)
...
![mermaid](/images/Java-advanced/IMG-20260707-000014.png)


关键点：**密钥只有服务端知道**。攻击者即使改了 Payload（比如把 `role` 从 user 改成 admin），也没有密钥算出正确的签名，服务端一验就发现对不上。

![mermaid](/images/Java-advanced/IMG-20260707-000015.png)
...
![mermaid](/images/Java-advanced/IMG-20260707-000016.png)
...
![mermaid](/images/Java-advanced/IMG-20260707-000017.png)


### 5.2 阶段二：带 token 访问接口

![mermaid](/images/Java-advanced/IMG-20260707-000018.png)
