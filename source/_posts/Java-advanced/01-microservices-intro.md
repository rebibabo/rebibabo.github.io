...
<img class="mermaid-img" src="/images/Java-advanced/IMG-20260707-000000.png" alt="mermaid diagram" style="display:block;width:auto;max-width:min(760px,100%);max-height:720px;height:auto;margin:1.5rem auto;object-fit:contain">
...
graph LR
    subgraph "微服务架构"
        direction LR
        US["用户服务<br/>+ DB"] <-->|网络调用| TS["投放服务<br/>+ DB"]
        TS <-->|网络调用| BS["计费服务<br/>+ DB"]
        BS <-->|网络调用| RS["报表服务<br/>+ DB"]
    end
</pre>
<img class="mermaid-img" src="/images/Java-advanced/IMG-20260707-000001.png" alt="mermaid diagram" style="display:block;width:auto;max-width:min(760px,100%);max-height:720px;height:auto;margin:1.5rem auto;object-fit:contain">
...
<img class="mermaid-img" src="/images/Java-advanced/IMG-20260707-000002.png" alt="mermaid diagram" style="display:block;width:auto;max-width:min(760px,100%);max-height:720px;height:auto;margin:1.5rem auto;object-fit:contain">
...
<pre style="display:none">
graph LR
    Service["投放服务"] -->|BillingClient.charge&#40;...&#41;| LB["负载均衡器（轮询）"]
    LB --> I1["实例1"]
    LB --> I2["实例2"]
    LB --> I3["实例3"]
</pre>
<img class="mermaid-img" src="/images/Java-advanced/IMG-20260707-000003.png" alt="mermaid diagram" style="display:block;width:auto;max-width:min(760px,100%);max-height:720px;height:auto;margin:1.5rem auto;object-fit:contain">
...
<pre style="display:none">
graph TB
    Frontend["前端"] --> Gateway["API 网关 (Gateway)<br/>统一鉴权 · 限流 · 日志"]
    Gateway --> US["用户服务"]
    Gateway --> TS["投放服务"]
    Gateway --> BS["计费服务"]
    Gateway --> RS["报表服务"]
</pre>
<img class="mermaid-img" src="/images/Java-advanced/IMG-20260707-000004.png" alt="mermaid diagram" style="display:block;width:auto;max-width:min(760px,100%);max-height:720px;height:auto;margin:1.5rem auto;object-fit:contain">
...
<pre style="display:none">
graph LR
    Closed["关闭 (Closed)"] -->|失败率超过阈值| Open["打开 (Open)"]
    Open -->|等待一段时间| Half["半开 (Half-Open)"]
    Half -->|试探请求成功| Closed
    Half -->|试探请求失败| Open
</pre>
<img class="mermaid-img" src="/images/Java-advanced/IMG-20260707-000005.png" alt="mermaid diagram" style="display:block;width:auto;max-width:min(760px,100%);max-height:720px;height:auto;margin:1.5rem auto;object-fit:contain">
