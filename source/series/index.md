...
<div class="series-grid">
  ...
  <a href="/categories/Java高并发底层原理/" class="series-card card-concurrency">
    ...
    <h2>Java 高并发底层原理</h2>
    <p>JMM · AQS · 线程池 · Future · 锁 · 死锁排查</p>
    <span class="card-count">29 篇</span>
  ...
  <a href="/categories/Java基础/" class="series-card card-basic">
    ...
    <h2>Java 基础</h2>
    <p>集合 · IO · 反射 · Spring · MyBatis</p>
    <span class="card-count">32 篇</span>
    <div class="card-arrow">→</div>
  </a>
  ...
  <a href="/categories/Java进阶/" class="series-card card-advanced">
    ...
    <h2>Java 进阶</h2>
    <p>Docker · K8s · 微服务 · 监控 · 链路追踪</p>
    <span class="card-count">7 篇</span>
    <div class="card-arrow">→</div>
  </a>

  <a href="/categories/llm-inference/" class="series-card card-llm">
    <div class="card-glow"></div>
    <div class="card-icon">
    ...
    <h2>LLM Inference</h2>
    <p>模型推理 · 量化 · KV Cache · 投机解码</p>
    <span class="card-count">6 篇</span>
    <div class="card-arrow">→</div>
  </a>
