...
这个目录是从原始博客笔记里提炼出来的知识库层。

它和 `source/_posts` 的分工是：

- `_posts` 保留原始长文和写作顺序
- `wiki` 提供系列导航、概念入口和后续的知识图谱

当前已建立的系列入口：

- [[wiki/series/java-basic|Java 基础系列]]
...
- 想按原文顺序读：从系列页进入，再跳到 `_posts`
- 想看学习路径：打开 maps 页面，按依赖关系从底层开始
- 想快速查术语：打开 glossary 词汇表
- 想看知识图谱：在 Obsidian 里筛选 `path:"wiki"`
- 想看混合关系：同时保留 `path:"wiki"` 和 `path:"_posts"`
